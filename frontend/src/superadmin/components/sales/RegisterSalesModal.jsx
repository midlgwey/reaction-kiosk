...
export const RegisterSaleModal = ({
  ...
  // Resetear isSubmitting cuando el modal se cierra
  useEffect(() => {
            ...
            <div className="space-y-3">
              ...
              <div className="relative" autoComplete="off">
                <input
                  ...
                  className={`w-full border rounded-md py-3 pl-10 pr-10 text-center text-lg tracking-widest font-bold focus:outline-none ${showPin ? "" : "pin-hidden"} ${
            ...
            <>
              ...
              <div>
                ...
                <input
                  ...
                  disabled={isEditing}
                  className="w-full border border-[#e0e0e0] rounded-md p-2.5 text-sm text-[#6B7280] focus:border-[#6A64F1] focus:outline-none disabled:opacity-60 disabled:cursor-not-allowed disabled:bg-gray-50 "
                />
              </div>
        ...
        {showForm && (
          <div className="px-6 py-4 border-t border-[#e0e0e0] flex justify-end gap-3 bg-gray-50">
            ...
            <button
              ...
              disabled={loading || isSubmitting || !employeeId || !saleDate || chilesSold === '' || saleDate > format(new Date(), 'yyyy-MM-dd')}
            ...
            >
              {loading || isSubmitting ? 'Guardando...' : isEditing ? 'Guardar Cambios' : 'Registrar Venta'}
            </button>
          </div>
        )}
      </div>
