...
export default function DailyQuestions() {
  ...
  return (
     <div className="bg-white border border-slate-200 p-6 rounded-3xl shadow-sm flex flex-col w-full min-h-[450px]">
      ...
      <div className="min-h-[150px] mt-2">
        {loading ? <ChartLoading /> : 
         ...
         (!data || data.length === 0) ? <div className="text-center py-20 italic text-slate-400 ">No se encontraron registros en la fecha seleccionada</div> :
